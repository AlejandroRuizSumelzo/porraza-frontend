...
import { useSignup } from "@/presentation/hooks/auth/use-signup";
 ...
 *
 * Pure presentation component for the signup form.
 * Handles form validation, submission, and user feedback.
 *
 * Clean Architecture:
 * - Located in presentation layer
 * - Uses DI hooks for business logic (useSignup)
...
export function SignupForm() {
  ...
  const signupSchema = createSignupSchema({
    nameMin: t("forms.validation.name_min"),
    ...
    confirmPasswordRequired: t("forms.validation.confirm_password_required"),
    passwordsMismatch: t("forms.validation.passwords_mismatch"),
  });
  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    if (registerResponse) {
      ...
      toast.success(t("auth.signup.toasts.success.title"), {
        description: t("auth.signup.toasts.success.description"),
        duration: 7000,
      });
      ...
      // Show error toast
      toast.error(t("auth.signup.toasts.error.title"), {
        description: error ?? t("auth.signup.toasts.error.description"),
      });
    }
  };
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-blue-700 dark:text-blue-400">
                      {t("auth.signup.banner.title")}
                    </p>
                    <p className="text-xs text-blue-600 dark:text-blue-500 mt-1">
                      {t("auth.signup.banner.description")}
                    </p>
                  </div>
                </div>
              </div>
