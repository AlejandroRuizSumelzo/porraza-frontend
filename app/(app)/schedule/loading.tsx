import { ScheduleGridSkeleton } from "@/presentation/components/schedule/schedule-skeleton";
    ...
    <div className="flex h-full flex-col">
      ...
      <main className="flex-1 overflow-auto p-4">
        <div className="mx-auto max-w-7xl space-y-8">
          ...
          {/* Grid Skeleton - Show 3 phases with varying match counts */}
          <ScheduleGridSkeleton phaseCount={3} />
        </div>
      </main>
    </div>
  );
